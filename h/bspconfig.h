...
#if defined(TRIBOARD_TC275B) || defined(TRIBOARD_TC27XB)
# define BOARD_NAME				"TriBoard-TC27xB"
# define BOARD_TITLE			"TC27xB TriBoard"
# define MCU_NAME				"TC27xB"
#elif defined(TRIBOARD_TC275C) || defined(TRIBOARD_TC277C) || defined(TRIBOARD_TC27XC)
# define BOARD_NAME				"TriBoard-TC27xC"
# define BOARD_TITLE			"TC27xC TriBoard"
# define MCU_NAME				"TC27xC"
#elif defined(TRIBOARD_TC275D) || defined(TRIBOARD_TC277D) || defined(TRIBOARD_TC27XD)
# define BOARD_NAME				"TriBoard-TC27xD"
# define BOARD_TITLE			"TC27xD TriBoard"
# define MCU_NAME				"TC27xD"
#elif (APPKIT_TC2X5 == 1)
# define BOARD_NAME				"AppKit-TC275TU"
# define BOARD_TITLE			"TC275TU AppKit"
# define MCU_NAME				"TC275x"
#elif (APPKIT_TC2X7 == 1)
# define BOARD_NAME				"AppKit-TC277TFT"
# define BOARD_TITLE			"TC277TFT AppKit"
# define MCU_NAME				"TC277x"
#elif (ON_SHIELDBUDDY == 1)
# define BOARD_NAME				"ShieldBuddy"
# define BOARD_TITLE			"ShieldBuddy"
# define MCU_NAME				"TC275x"
#else
# define BOARD_NAME				"TriBoard-TC27xA"
# define BOARD_TITLE			"TC27xA TriBoard"
# define MCU_NAME				"TC27xA"
...
#elif (ON_SHIELDBUDDY == 1)
/* ShieldBuddy: no available LEDs */
#define MAX_LED					0	/* number of available LEDs */
#else
/* TriBoard-TC27xx: P33.6 ... P33.13 --> LED D501 ... D508 */
